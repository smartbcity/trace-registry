package city.smartb.registry.ver.test.f2.activity.query


import city.smartb.registry.f2.activity.api.ActivityEndpoint
import city.smartb.registry.f2.activity.domain.model.ActivityDTO
import city.smartb.registry.f2.activity.domain.query.ActivityPageQuery
...
class ActivityPageSteps: En, city.smartb.registry.ver.test.VerCucumberStepsDefinition() {
