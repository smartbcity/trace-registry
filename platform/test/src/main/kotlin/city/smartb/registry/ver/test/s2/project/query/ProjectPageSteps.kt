package city.smartb.registry.ver.test.s2.project.query

import city.smartb.registry.f2.project.api.ProjectEndpoint
import city.smartb.registry.f2.project.domain.model.ProjectDTO
import city.smartb.registry.f2.project.domain.query.ProjectPageQuery
...
class ProjectPageSteps: En, city.smartb.registry.ver.test.VerCucumberStepsDefinition() {
