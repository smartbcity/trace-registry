...
interface ActivityStepCreateCommandDTO {
    ...
    /**
     * @ref [city.smartb.registry.f2.activity.domain.model.ActivityStepDTO.name]
     */
    val name: String

    /**
     * @ref [city.smartb.registry.f2.activity.domain.model.ActivityStepDTO.description]
     */
    val description: String?

    /**
     * @ref [city.smartb.registry.f2.activity.domain.model.ActivityStepDTO.hasConcept]
     */
