package city.smartb.registry.f2.asset.order.api.service

import city.smartb.im.commons.auth.AuthenticationProvider
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderCancelCommandDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderCanceledEventDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderCompleteCommandDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderCompletedEventDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderDeleteCommandDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderDeletedEventDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderPlaceCommandDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderPlacedEventDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderSubmitCommandDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderSubmittedEventDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderUpdateCommandDTOBase
import city.smartb.registry.f2.asset.order.domain.command.AssetOrderUpdatedEventDTOBase
...
import city.smartb.registry.s2.order.api.OrderAggregateService
import city.smartb.registry.s2.order.api.OrderFinderService
