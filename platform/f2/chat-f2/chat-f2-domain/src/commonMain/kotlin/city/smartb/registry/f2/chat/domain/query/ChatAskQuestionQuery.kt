package city.smartb.registry.f2.chat.domain.query

import city.smartb.registry.f2.chat.domain.model.ChatMessage
import city.smartb.registry.f2.chat.domain.model.ChatMessageDTO
import city.smartb.registry.f2.chat.domain.model.ChatMetadata
import city.smartb.registry.f2.chat.domain.model.ChatMetadataDTO
 ...
 * @d2 function
 * @parent [city.smartb.registry.f2.chat.domain.D2ChatF2Page]
 * @order 10
 */
