package city.smartb.registry.f2.project.api

import city.smartb.fs.s2.file.client.FileClient
import city.smartb.fs.spring.utils.serveFile
import city.smartb.registry.f2.project.api.service.ProjectF2FinderService
import city.smartb.registry.f2.project.api.service.ProjectPoliciesEnforcer
import city.smartb.registry.f2.project.domain.ProjectCommandApi
import city.smartb.registry.f2.project.domain.ProjectQueryApi
...
import city.smartb.registry.f2.project.domain.query.ProjectDownloadFileQuery
import city.smartb.registry.f2.project.domain.query.ProjectGetByIdentifierFunction
import city.smartb.registry.f2.project.domain.query.ProjectGetByIdentifierResult
import city.smartb.registry.f2.project.domain.query.ProjectGetFunction
import city.smartb.registry.f2.project.domain.query.ProjectGetResult
import city.smartb.registry.f2.project.domain.query.ProjectListFilesFunction
import city.smartb.registry.f2.project.domain.query.ProjectListFilesResult
import city.smartb.registry.f2.project.domain.query.ProjectPageFunction
import city.smartb.registry.f2.project.domain.query.ProjectPageResult
...
import city.smartb.registry.s2.project.api.ProjectAggregateService
