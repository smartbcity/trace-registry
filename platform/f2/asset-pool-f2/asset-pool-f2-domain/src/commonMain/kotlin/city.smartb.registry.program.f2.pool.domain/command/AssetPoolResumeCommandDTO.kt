 ...
 * @d2 function
 * @order 30
 * @child [city.smartb.registry.program.s2.asset.domain.command.pool.AssetPoolResumeCommandDTO]
 */
typealias AssetPoolResumeFunction = F2Function<AssetPoolResumeCommandDTOBase, AssetPoolResumedEventDTOBase>

@JsExport
interface AssetPoolResumeCommandDTO: city.smartb.registry.program.s2.asset.domain.command.pool.AssetPoolResumeCommandDTO
