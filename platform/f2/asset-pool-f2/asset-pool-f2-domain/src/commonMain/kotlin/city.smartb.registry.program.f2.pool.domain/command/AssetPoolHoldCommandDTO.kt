 ...
 * @d2 function
 * @order 20
 * @child [city.smartb.registry.program.s2.asset.domain.command.pool.AssetPoolHoldCommandDTO]
 */
typealias AssetPoolHoldFunction = F2Function<AssetPoolHoldCommandDTOBase, AssetPoolHeldEventDTOBase>

@JsExport
interface AssetPoolHoldCommandDTO: city.smartb.registry.program.s2.asset.domain.command.pool.AssetPoolHoldCommandDTO
