...
interface AssetPoolPageResultDTO: PageQueryResultDTO<city.smartb.registry.f2.pool.domain.model.AssetPoolDTO>
...
data class AssetPoolPageResult(
    override val items: List<city.smartb.registry.f2.pool.domain.model.AssetPoolDTO>,
