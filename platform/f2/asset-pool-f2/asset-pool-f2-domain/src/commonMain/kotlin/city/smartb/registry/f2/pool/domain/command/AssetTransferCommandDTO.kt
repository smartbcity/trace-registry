 ...
 * @order 110
 */
typealias AssetTransferFunction = F2Function<city.smartb.registry.f2.pool.domain.command.AssetTransferCommandDTOBase, city.smartb.registry.f2.pool.domain.command.AssetTransferredEventDTOBase>
...
): city.smartb.registry.f2.pool.domain.command.AssetTransferCommandDTO,
    city.smartb.registry.f2.pool.domain.command.AbstractAssetTransactionCommand {
...
//    override val orderId: OrderId
    override val id: AssetPoolId
): city.smartb.registry.f2.pool.domain.command.AssetTransferredEventDTO
