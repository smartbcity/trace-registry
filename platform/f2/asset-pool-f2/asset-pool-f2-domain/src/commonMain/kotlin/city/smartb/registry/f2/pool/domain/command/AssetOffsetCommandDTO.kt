 ...
 * @order 120
 */
typealias AssetOffsetFunction = F2Function<city.smartb.registry.f2.pool.domain.command.AssetOffsetCommandDTOBase, city.smartb.registry.f2.pool.domain.command.AssetOffsettedEventDTOBase>
...
): city.smartb.registry.f2.pool.domain.command.AssetOffsetCommandDTO,
...
//    override val orderId: OrderId
    override val id: AssetPoolId
): city.smartb.registry.f2.pool.domain.command.AssetOffsettedEventDTO
