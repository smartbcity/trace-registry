...
interface AssetTransactionGetResultDTO {
    val item: city.smartb.registry.f2.pool.domain.model.AssetTransactionDTO?
}
...
data class AssetTransactionGetResult(
    override val item: city.smartb.registry.f2.pool.domain.model.AssetTransactionDTOBase?
