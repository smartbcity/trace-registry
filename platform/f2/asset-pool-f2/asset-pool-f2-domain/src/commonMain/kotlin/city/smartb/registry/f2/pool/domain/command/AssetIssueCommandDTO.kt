 ...
 * @order 100
 */
typealias AssetIssueFunction = F2Function<city.smartb.registry.f2.pool.domain.command.AssetIssueCommandDTOBase, city.smartb.registry.f2.pool.domain.command.AssetIssuedEventDTOBase>
 ...
 */
@JsExport
interface AssetIssueCommandDTO: city.smartb.registry.f2.pool.domain.command.AbstractAssetTransactionCommand {
    /**
...
): city.smartb.registry.f2.pool.domain.command.AssetIssueCommandDTO {
...
): city.smartb.registry.f2.pool.domain.command.AssetIssuedEventDTO
