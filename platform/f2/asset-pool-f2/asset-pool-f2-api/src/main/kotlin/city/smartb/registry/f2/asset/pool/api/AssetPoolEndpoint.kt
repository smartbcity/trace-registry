package city.smartb.registry.f2.asset.pool.api

import city.smartb.fs.s2.file.client.FileClient
import city.smartb.fs.spring.utils.serveFile
import city.smartb.registry.api.commons.utils.anyNotNull
import city.smartb.registry.f2.asset.pool.api.service.AssetPoolF2AggregateService
import city.smartb.registry.f2.asset.pool.api.service.AssetPoolF2FinderService
import city.smartb.registry.f2.asset.pool.api.service.AssetPoolPoliciesEnforcer
import city.smartb.registry.f2.asset.pool.api.service.AssetTransactionF2FinderService
import city.smartb.registry.f2.asset.pool.domain.AssetPoolApi
import city.smartb.registry.f2.asset.pool.domain.command.AssetIssueFunction
import city.smartb.registry.f2.asset.pool.domain.command.AssetIssuedEventDTOBase
import city.smartb.registry.f2.asset.pool.domain.command.AssetOffsetFunction
import city.smartb.registry.f2.asset.pool.domain.command.AssetOffsettedEventDTOBase
import city.smartb.registry.f2.asset.pool.domain.command.AssetPoolCloseFunction
import city.smartb.registry.f2.asset.pool.domain.command.AssetPoolClosedEventDTOBase
import city.smartb.registry.f2.asset.pool.domain.command.AssetPoolCreateFunction
import city.smartb.registry.f2.asset.pool.domain.command.AssetPoolCreatedEventDTOBase
import city.smartb.registry.f2.asset.pool.domain.command.AssetPoolHeldEventDTOBase
...
import city.smartb.registry.f2.asset.pool.domain.command.AssetPoolResumedEventDTOBase
import city.smartb.registry.f2.asset.pool.domain.command.AssetRetireFunction
import city.smartb.registry.f2.asset.pool.domain.command.AssetRetiredEventDTOBase
import city.smartb.registry.f2.asset.pool.domain.command.AssetTransferFunction
import city.smartb.registry.f2.asset.pool.domain.command.AssetTransferredEventDTOBase
import city.smartb.registry.f2.asset.pool.domain.query.AssetCertificateDownloadQuery
import city.smartb.registry.f2.asset.pool.domain.query.AssetPoolGetFunction
import city.smartb.registry.f2.asset.pool.domain.query.AssetPoolGetResultDTOBase
...
import city.smartb.registry.f2.asset.pool.domain.query.AssetTransactionGetResult
import city.smartb.registry.f2.asset.pool.domain.query.AssetTransactionPageFunction
import city.smartb.registry.f2.asset.pool.domain.query.AssetTransactionPageResultDTOBase
