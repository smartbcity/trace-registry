...
class AssetPoolF2FinderService(
    ...
    suspend fun get(id: AssetPoolId): city.smartb.registry.f2.pool.domain.model.AssetPoolDTOBase {
        return assetPoolFinderService.get(id).toDTO()
    }

    suspend fun getOrNull(id: AssetPoolId): city.smartb.registry.f2.pool.domain.model.AssetPoolDTOBase? {
    ...
    ): PageDTO<city.smartb.registry.f2.pool.domain.model.AssetPoolDTOBase> {
