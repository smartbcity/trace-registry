...
export namespace city.smartb.registry.program.s2.protocol.domain.automate {
    interface ProtocolInitCommand extends s2.dsl.automate.S2InitCommand {

    }
    interface ProtocolCommand extends s2.dsl.automate.S2Command<string> {
        readonly id: string;

    }
    interface ProtocolEvent extends f2.dsl.cqrs.Event, s2.dsl.automate.WithId<string> {
        readonly id: string;

    }
}
export namespace city.smartb.registry.program.s2.protocol.domain.command {
    interface ProtocolUpdateCommandDTO extends city.smartb.registry.program.s2.protocol.domain.automate.ProtocolCommand, city.smartb.registry.program.s2.protocol.domain.automate.ProtocolInitCommand, s2.dsl.automate.model.WithS2State<s2.dsl.automate.S2State/* city.smartb.registry.program.s2.protocol.domain.automate.ProtocolState */>/*, city.smartb.registry.program.s2.protocol.domain.model.ProtocolDTO */ {
        readonly id: string;
        s2State(): s2.dsl.automate.S2State/* city.smartb.registry.program.s2.protocol.domain.automate.ProtocolState */;

    }
    interface ProtocolUpdatedEventDTO extends city.smartb.registry.program.s2.protocol.domain.automate.ProtocolEvent {
        readonly id: string;

    }
}
export namespace city.smartb.registry.program.f2.protocol.domain.policy {
    const ProtocolPolicies: {
        ...
        canUpdate(authedUser: city.smartb.registry.program.api.commons.auth.AuthedUserDTO, protocol: (city.smartb.registry.program.s2.protocol.domain.automate.ProtocolCommand & city.smartb.registry.program.s2.protocol.domain.automate.ProtocolInitCommand & s2.dsl.automate.model.WithS2State<s2.dsl.automate.S2State/* city.smartb.registry.program.s2.protocol.domain.automate.ProtocolState */>)/* city.smartb.registry.program.s2.protocol.domain.model.ProtocolDTO */): boolean;
        canDelete(authedUser: city.smartb.registry.program.api.commons.auth.AuthedUserDTO, protocol: (city.smartb.registry.program.s2.protocol.domain.automate.ProtocolCommand & city.smartb.registry.program.s2.protocol.domain.automate.ProtocolInitCommand & s2.dsl.automate.model.WithS2State<s2.dsl.automate.S2State/* city.smartb.registry.program.s2.protocol.domain.automate.ProtocolState */>)/* city.smartb.registry.program.s2.protocol.domain.model.ProtocolDTO */): boolean;
    };
}
export namespace city.smartb.registry.program.f2.protocol.domain.query {
    interface ProtocolGetQueryDTO {
        readonly id: string;

    }
    interface ProtocolGetResultDTO {
        readonly item: Nullable<city.smartb.registry.program.s2.protocol.domain.automate.ProtocolCommand & city.smartb.registry.program.s2.protocol.domain.automate.ProtocolInitCommand & s2.dsl.automate.model.WithS2State<s2.dsl.automate.S2State/* city.smartb.registry.program.s2.protocol.domain.automate.ProtocolState */>>/* Nullable<city.smartb.registry.program.s2.protocol.domain.model.ProtocolDTO> */;
...
export namespace city.smartb.registry.program.f2.protocol.domain.query {
    ...
    interface ProtocolPageResultDTO extends f2.dsl.cqrs.page.PageDTO<(city.smartb.registry.program.s2.protocol.domain.automate.ProtocolCommand & city.smartb.registry.program.s2.protocol.domain.automate.ProtocolInitCommand & s2.dsl.automate.model.WithS2State<s2.dsl.automate.S2State/* city.smartb.registry.program.s2.protocol.domain.automate.ProtocolState */>)/* city.smartb.registry.program.s2.protocol.domain.model.ProtocolDTO */> {
        readonly total: number;
        readonly items: kotlin.collections.List<city.smartb.registry.program.s2.protocol.domain.model.ProtocolDTO>;

    }
}
export as namespace verified_emission_reduction_registry_protocol_f2_domain;