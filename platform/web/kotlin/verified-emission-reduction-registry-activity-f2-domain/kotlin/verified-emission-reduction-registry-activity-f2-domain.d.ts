...
export namespace city.smartb.registry.program.f2.activity.domain.model {
    ...
    class Activity implements city.smartb.registry.program.f2.activity.domain.model.ActivityDTO {
        ...
        component6(): Array<city.smartb.registry.program.f2.activity.domain.model.Activity>;
        component7(): number;
        copy(identifier?: string, name?: string, type?: string, description?: string, hasQualifiedRelation?: Array<string>, hasRequirement?: Array<city.smartb.registry.program.f2.activity.domain.model.Activity>, progression?: number): city.smartb.registry.program.f2.activity.domain.model.Activity;
        toString(): string;
        hashCode(): number;
        equals(other?: any): boolean;
...
export namespace city.smartb.registry.program.f2.activity.domain.policy {
    const ActivityPolicies: {
        ...
        canCreate(authedUser: city.smartb.registry.program.api.commons.auth.AuthedUserDTO/* city.smartb.registry.program.api.commons.auth.AuthedUser */): boolean;
        canCreateStep(authedUser: city.smartb.registry.program.api.commons.auth.AuthedUserDTO/* city.smartb.registry.program.api.commons.auth.AuthedUser */): boolean;
        canFulfillTask(authedUser: city.smartb.registry.program.api.commons.auth.AuthedUserDTO/* city.smartb.registry.program.api.commons.auth.AuthedUser */): boolean;
    };
}
