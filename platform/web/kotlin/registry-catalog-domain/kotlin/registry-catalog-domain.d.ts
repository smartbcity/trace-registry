...
export namespace city.smartb.registry.s2.catalog.domain.automate {
...
export namespace city.smartb.registry.s2.catalog.domain.command {
    interface CatalogCloseCommandDTO extends city.smartb.registry.s2.catalog.domain.automate.CatalogCommand {
        readonly id: string;

    }
}
export namespace city.smartb.registry.s2.catalog.domain.model {
...
<<<<<<< HEAD
        ...
        readonly services?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.DataService>[] */;
        readonly catalogs?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.DcatApCatalog>[] */;
        readonly catalogRecords?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.DcatCatalogRecord>[] */;
...
<<<<<<< HEAD
        ...
        readonly type?: string;
        readonly relation?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.Relationship>[] */;
        readonly qualifiedRelation?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.Relationship>[] */;
        readonly keywords?: any/* Nullable<string>[] */;
        readonly landingPage?: string;
        readonly qualifiedAttribution?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.Attribution>[] */;
        readonly license?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.LicenseDocument> */;
        readonly rights?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.Rights> */;
        readonly hasPart?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.CatalogedResource>[] */;
        readonly hasPolicy?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.Policy>[] */;
...
<<<<<<< HEAD
        ...
        readonly seriesMember?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.DcatApDatasetMember>[] */;
        readonly identifier: string;
        ...
        readonly temporalCoverage?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.PeriodOfTime> */;
        readonly temporalResolution?: string;
        readonly wasGeneratedBy?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.Activity> */;
...
>>>>>>> origin/main
    ...
    interface DcatApDatasetMember extends city.smartb.registry.s2.catalog.domain.model.DcatDataset {
        readonly title: string;
        readonly inSeries: city.smartb.registry.s2.catalog.domain.model.DcatApDatasetSeries;
...
>>>>>>> origin/main
    ...
    interface DcatCatalog extends city.smartb.registry.s2.catalog.domain.model.CatalogedResource {
        readonly identifier: string;
        readonly homepage: string;
        readonly img: string;
<<<<<<< HEAD
        ...
        readonly datasets?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.DcatDataset>[] */;
        readonly services?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.DataService>[] */;
        readonly catalogs?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.DcatCatalog>[] */;
        readonly catalogRecords?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.DcatCatalogRecord>[] */;
        readonly accessRights?: string;
        readonly conformsTo?: any/* Nullable<city.smartb.registry.s2.catalog.domain.model.SkosConceptScheme>[] */;
        readonly contactPoint?: string;
...
export as namespace registry_catalog_domain;