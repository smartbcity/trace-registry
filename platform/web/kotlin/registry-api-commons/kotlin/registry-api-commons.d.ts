...
export namespace city.smartb.registry.api.commons.exception {
    const ExceptionCodes: {
...
export namespace city.smartb.registry.api.commons.model {
    const RedirectableRoutes: {
        quotations(): string;
        projects(): string;
    };
}
export as namespace registry_api_commons;