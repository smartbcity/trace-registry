...
export interface AssetTransactionPageResult extends city.smartb.registry.f2.asset.pool.domain.query.AssetTransactionPageResultDTO { }
...
export interface AssetGetQuery extends city.smartb.registry.f2.asset.pool.domain.query.AssetStatsGetQueryDTO { }
export interface AssetGetResult extends city.smartb.registry.f2.asset.pool.domain.query.AssetStatsGetResultDTO { }
...
export interface AssetTransactionGetQuery extends city.smartb.registry.f2.asset.pool.domain.query.AssetTransactionGetQueryDTO { }
export interface AssetTransactionGetResult extends city.smartb.registry.f2.asset.pool.domain.query.AssetTransactionGetResultDTO { }
